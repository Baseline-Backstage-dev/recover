...
LAMBDA_RUNTIME_VERSION = aws.lambda_.Runtime.PYTHON3D9
API_AUTHORIZATION_HEADER = "method.request.header.Authorization"

ACCEPTED_API_METHODS = ["get", "post", "delete", "put", "patch", "options", "any", "head"]


# isTaggable returns true if the given resource type is an AWS resource that supports tags.
def aws_is_taggable(t):
    return t in aws_taggable_resource_types


# taggable_resource_types is a list of known AWS type tokens that are taggable.
aws_taggable_resource_types = [
